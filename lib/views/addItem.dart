...
class MyCustomFormState extends State<MyCustomForm> {
  ...
  final list = [DropdownMenuItem<String>(child:Text("Dairy"), value: "Dairy",),DropdownMenuItem<String>(child:Text("Meat"), value: "Meat",),
  DropdownMenuItem<String>(child:Text("Pantry"), value: "Pantry",),DropdownMenuItem<String>(child:Text("Fruits"), value: "Fruits",),DropdownMenuItem<String>(child:Text("Vegetables"), value: "Vegetables",),DropdownMenuItem<String>(child:Text("Frozen"), value: "Frozen",),
  DropdownMenuItem<String>(child:Text("Bakery"), value: "Bakery",), DropdownMenuItem<String>(child:Text("Seafood"), value: "Seafood",), DropdownMenuItem<String>(child:Text("Beverages"), value: "Beverages",),
  DropdownMenuItem<String>(child:Text("Deli"), value: "Deli",), DropdownMenuItem<String>(child:Text("Personal Care"), value: "Personal Care",), DropdownMenuItem<String>(child:Text("Condiments"), value: "Condiments",), DropdownMenuItem<String>(child:Text("Cleaning"), value: "Cleaning",),
  DropdownMenuItem<String>(child:Text("Baking"), value: "Baking",)];
  var dblist = [];
  var category = "Dairy"; 
    ...
    return Center(
      ...
      child: Column(
        ...
        children: [
          ...
          Text("Couldnt Find Your Item?",style: TextStyle(fontSize: 30.00,),),
           SizedBox(
            height: 30,
          ),
          DropdownButtonFormField(
            decoration: InputDecoration(labelText: "Select Item Category", labelStyle: TextStyle(color: Colors.green)),
            items: list, 
              ...
              FloatingActionButton.extended(
                ...
                onPressed: () async {
                  if (_formKey.currentState.validate()) {
                    ...
                    if(test){
                      dblist = [];
                      Scaffold.of(ctx).showSnackBar(SnackBar(content: Text("Data Sent"),));
                    }
                    else{
                      Scaffold.of(ctx).showSnackBar(SnackBar(content: Text("Data failed to send"),));
                    }
  ...
  Future<bool> addData() async{
    ...
    var selectcatquery = "Select CategoryID from Categories Where Categories.Name = ?;";
    ...
    var insertbranditems = "Insert into BrandsItems (BrandID,ItemID) Values(?,?);";
    ...
    print(catID); 
    var result; 
    result = await database.manualQuery(insertitem,[itemname,catID[0].values[0].toString()]);
    print(result);
    ...
    result = await database.manualQuery(insertbranditems,[brandID[0].values[0],itemID[0].values[0]]);
    return true; 
